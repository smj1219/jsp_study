...
<body>
	<div class="container">
		...
		<ul>
			...
			<li><a href="${pageContext.request.contextPath }/friend">친구 한 명의 정보</a></li>
		</ul>
		...
		<%
			//session 영역에 "nick"이라는 키값으로 저장된 물자열이 있는지 확인한다
			String nick=(String)session.getAttribute("nick");
		%>
		<%if(nick!=null){ %>
			<p>
				<strong><%=nick %></strong> 님 반갑습니다
				<a href="${pageContext.request.contextPath }/test/logout.jsp">로그아웃(세션초기화)</a>
			</p>
		<%} %>
