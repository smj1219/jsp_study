	...
	<div class="container">
		<nav>
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item active">내용수정</li>
			</ol>
		</nav>
		<h1>방명록 글 수정 폼</h1>
		<form action="${pageContext.request.contextPath }/guest/update.jsp" method="post">
			...
			<div>
				...
				<textarea class="form-control" placeholder="내용 입력..." style="height: 200px" name="content" id="content" ><%=dto.getContent() %></textarea>
			</div>
			<div>
